...
// interface IChangeColorComponent {
// 	offset: number;
...
// const changeColorComponent: ComponentDefinition<IChangeColorComponent> = {
// 	offset: 0,
...
// 		// FIXME not generic
// 		const setColor = ({ newColor, button }: { newColor: string, button: any /* FIXME */ }) => {
// 			this.modelMesh = this.el.getObject3D('mesh').getObjectByName('Car') as THREE.Mesh;
...
// 				if (!!this.modelMesh) {
// 					(this.modelMesh.material as any).map = texture;
// 					(this.modelMesh.material as Material).needsUpdate = true;
// 					this.modelMesh.traverse((node: any) => {
...
// 				// FIXME
// 				// no custom texture
// 				(this.modelMesh.material as any).map = null;
// 				(this.modelMesh.material as Material).needsUpdate = true;
// 				this.modelMesh.traverse((node: any) => {
...
// 		if (colorList.length > 5 && container) {
...
// 		const objectMesh = this.modelMesh?.getObjectByName('Car') as THREE.Mesh;

// 		if (!!objectMesh) {
// 			(objectMesh.material as any).map.repeat.x = 2;
// 			(objectMesh.material as any).map.repeat.y = 2;
// 			(objectMesh.material as any).map.offset.x = this.offset;
// 			this.offset += 0.002
// 		}
...
// interface IAnnotationComponent {
// 	// FIXME
// 	// schema: {};
// 	torus: any;
// 	label?: HTMLElement;
...
// const annotationComponent: ComponentDefinition<IAnnotationComponent> = {
// 	schema: {
...
// 			// FIXME set active before timeout done
// 			setTimeout(() => {
// 				if (!!this.label) {
...
// 		let labelActivated: boolean; let
// 			hsActivated: boolean;
...
// 		// FIXME
// 		this.labelRenderer = new (THREE as any).CSS2DRenderer();
...
// 		// FIXME any
// 		this.labelObj = new (THREE as any).CSS2DObject(this.label)
...
// 		// FIXME any
// 		const distance = this.worldPos.distanceTo((this.camera as any)?.el.object3D.position)
...
// // FIXME hard-coded targets
// const targets = ['Front-Driver', 'Back-Driver', 'Front-Pass', 'Back-Pass'];

// interface IProximityComponent {
// 	activateWindows?: () => void;
// 	deactivateWindows?: () => void;
// }

// const proximityComponent: ComponentDefinition<IProximityComponent> = {
// 	schema: {
...
// 		// FIXME any
// 		const targetPosition = (document?.getElementById(this.data.target) as any)?.object3D.position
...
// interface IAbsPinchScaleComponent {
// 	initialScale?: THREE.Vector3;
// 	scaleFactor?: number;
// 	handleEvent?: EventListenerOrEventListenerObject & Function;
// }

// const absPinchScaleComponent: ComponentDefinition<IAbsPinchScaleComponent> = {
// 	schema: {
// 		min: { default: 0.1 },
// 		max: { default: 5 },
